...
class RegistryHelper {
  ...
  private static final Function<Collector, ThroughputMeter> THROUGHPUT_METER = metric -> {
    if (metric != null) {
  ...
  public static void shutdown(CollectorRegistry registry) {
    registry.removeMatching((name, metric) -> true);
  }

  public static ThroughputMeter throughputMeter(CollectorRegistry registry, String name) {
    return getOrAdd(registry, name, THROUGHPUT_METER);
  }

  public static ThroughputTimer throughputTimer(CollectorRegistry registry, String name) {
    return getOrAdd(registry, name, THROUGHPUT_TIMER);
  }

  public static <M extends Metric> M getOrAdd(CollectorRegistry registry, String name, Function<Metric, M> metricProvider) {
